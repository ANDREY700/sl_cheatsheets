...
teams = st.multiselect('Team names', options=[
    ...
    'ResNet ➡️ https://github.com/Elbrus-DataScience/nn_resnet_team', 
    'Inception ➡️ https://github.com/Elbrus-DataScience/nn_inception_team', 
    'DenseNet ➡️ https://github.com/Elbrus-DataScience/nn_densenet_team', 
    'VGG ➡️ https://github.com/Elbrus-DataScience/nn_vgg_team', 
    'AlexNet ➡️ https://github.com/Elbrus-DataScience/nn_alexnet_team',  
    'YOLO ➡️ https://github.com/Elbrus-DataScience/cv_yolo', 
    'FasterRCNN ➡️ https://github.com/Elbrus-DataScience/cv_faster-rcnn', 
    'Mask RCNN ➡️ https://github.com/Elbrus-DataScience/cv_mask-rcnn', 
    'BERT ➡️ https://github.com/Elbrus-DataScience/nlp_lstm_team', 
    'LSTM ➡️ https://github.com/Elbrus-DataScience/nlp_bert_team', 
    'GPT ➡️ https://github.com/Elbrus-DataScience/nlp_gpt_team', 
    'RNN', 'LSTM', 
    'SQL', 'PySpark'
...
names = st.radio(
            ...
            [
                ...
                'Тимур, Диана, Данила, Роман, Марина, Александр, Андрей, Алексей, Елизавета, Ламберт, Ольга',
                'Артём, Галина, Сергей, Владислав, Александра, Алексей, Алина, Артемий, Земфира, Константин, Никита, Даниил, Евгений'
